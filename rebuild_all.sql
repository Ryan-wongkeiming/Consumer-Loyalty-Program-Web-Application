...
('blackmores-subscribe', 'Blackmores Subscribe & Save', 'Get your favourite Blackmores products delivered regularly with exclusive subscriber benefits and savings.', 1149750, NULL, 'https://images.pexels.com/photos/3683074/pexels-photo-3683074.jpeg?auto=compress&cs=tinysrgb&w=500', 'Subscription Service', ARRAY['Save 15% on every order (infant formula 10%)', 'Free shipping on all deliveries', 'Flexible delivery schedule', 'Priority customer support', 'Exclusive subscriber-only products'], ARRAY['Varies by selected products'], 'As per individual product instructions', 4.8, 1247, TRUE, TRUE, NULL, NULL, ARRAY['All'], ARRAY[]::TEXT[], ARRAY['General Health']),
