...
import { Star, Heart, Flag, MoreHorizontal, User, Image as ImageIcon, Video, X } from 'lucide-react';
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center space-x-4 text-sm">
                    <button className="flex items-center space-x-1 text-gray-500 hover:text-carehub-teal transition-colors">
