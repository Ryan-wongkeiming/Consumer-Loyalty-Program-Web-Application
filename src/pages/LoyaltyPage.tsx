...
import { ArrowLeft, Gift, Camera, Trophy, CheckCircle, AlertCircle, Sparkles, Coins } from 'lucide-react';
import { useAuth } from '../context/AuthContext';
import { getUserLoyaltyPoints, redeemLoyaltyCode, getLoyaltyGifts, getUserRedemptions } from '../lib/auth';
        ...
        <div className="bg-white rounded-2xl shadow-lg mb-8 border border-gray-100">
          <div className="border-b border-gray-200">
            <nav className="flex space-x-8 px-8">
              ...
              ] as { id: 'redeem' | 'gifts' | 'history'; label: string; icon: React.ComponentType<{ className?: string }> }[]).map((tab) => {
                const Icon = tab.icon;
                return (
                  <button
                    key={tab.id}
                    ...
                    <div>
                      ...
                      <div className="flex space-x-3">
                        <input
                          ...
                          placeholder="Nhập mã thưởng (VD: CAREHUB2025)"
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-6">
                    <div className="text-center">
                      ...
                      <h3 className="text-lg font-semibold text-yellow-900 mb-2">
                        Tham gia chương trình tích điểm CareHub
                      </h3>
                ...
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">
                      Tham gia chương trình thưởng CareHub
                    </h3>
                    <div className="mt-2">
