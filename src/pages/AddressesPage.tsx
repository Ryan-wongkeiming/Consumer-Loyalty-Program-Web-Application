                    ...
                    <div className="flex items-center space-x-2">
                      {!address.is_default && (
                        <button
                          ...
                          className="text-carehub-teal hover:text-carehub-teal-dark transition-colors text-sm font-medium"
                        >
                          Đặt mặc định
                        </button>
                      )}
                      <button
                        ...
                        className="text-carehub-teal hover:text-carehub-teal-dark transition-all duration-300 p-2 rounded-lg hover:bg-green-50 hover:scale-110"
                      >
