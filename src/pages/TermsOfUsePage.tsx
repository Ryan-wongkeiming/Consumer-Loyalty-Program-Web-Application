      ...
      <div className="relative bg-gradient-to-r from-carehub-teal to-carehub-teal-dark text-white py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-green-100 max-w-3xl mx-auto">
            Hướng dẫn và quy định sử dụng trang web CareHub
          </p>
        </div>
      </div>
            ...
            <div className="space-y-8">
              <section>
                <p className="text-gray-700 leading-relaxed text-lg">
                  Chào mừng bạn đến với trang web của CareHub. Khi tiếp tục truy cập hoặc sử dụng bất kỳ nội dung, dịch vụ hay tính năng nào trên trang này, bạn đã chấp thuận tuân thủ các điều khoản dưới đây. Vui lòng đọc kỹ trước khi tiếp tục.
                </p>
              </section>
              ...
              <section>
                <div className="flex items-center space-x-3 mb-4">
                  <FileText className="w-6 h-6 text-carehub-teal" />
              ...
              <section>
                ...
                <div className="bg-yellow-50 rounded-lg p-6 border-l-4 border-yellow-400">
                  <p className="text-gray-700 leading-relaxed">
                    Thông tin sức khỏe trên trang web chỉ dành cho mục đích tham khảo, không thay thế lời khuyên y tế chuyên nghiệp. CareHub không chịu trách nhiệm về bất kỳ quyết định điều trị, thay đổi thuốc hoặc chế độ nào dựa trên nội dung tại đây. Luôn tham khảo ý kiến bác sĩ trước khi áp dụng.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Trong phạm vi pháp luật cho phép, CareHub không chịu trách nhiệm cho mọi tổn thất gián tiếp, đặc biệt, ngẫu nhiên hoặc hậu quả phát sinh từ việc truy cập hay sử dụng trang web, kể cả khi đã được cảnh báo về khả năng xảy ra thiệt hại.
                </p>
              </section>

              <section>
                <div className="flex items-center space-x-3 mb-4">
                  <ExternalLink className="w-6 h-6 text-carehub-teal" />
                  <h2 className="text-2xl font-bold text-gray-900">6. Liên Kết Đến Trang Khác</h2>
                </div>
                <p className="text-gray-700 leading-relaxed">
                  Trang web có thể chứa liên kết đến bên thứ ba. Những trang đó hoạt động độc lập, CareHub không kiểm soát và không chịu trách nhiệm về nội dung hoặc chính sách bảo mật của họ.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  CareHub có quyền cập nhật Điều Khoản bất kỳ lúc nào. Thay đổi có hiệu lực ngay khi được đăng. Việc bạn tiếp tục sử dụng sau khi điều khoản mới xuất bản đồng nghĩa bạn đồng ý với các cập nhật đó.
                </p>
              </section>
