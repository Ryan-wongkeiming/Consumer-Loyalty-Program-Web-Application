    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <Link
            to="/"
            className="inline-flex items-center text-carehub-teal hover:text-carehub-teal-dark transition-colors group mb-4"
          >
          ...
          <div className="flex items-center space-x-3 mb-4">
            <Search className="w-6 h-6 text-carehub-teal" />
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex items-center space-x-2">
                          ...
                          {result.brand && result.brand !== 'CareHub' && (
                      ...
                      <Link to={result.url}>
                        <h3 className="text-xl font-bold text-gray-900 mb-2 hover:text-carehub-teal transition-colors line-clamp-2">
                          {result.title}
                        </h3>
                      </Link>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          {result.type === 'Product' && result.price && (
                            <div className="flex items-center space-x-2">
                              <span className="text-xl font-bold text-carehub-teal">
                          ...
                          {result.type === 'Product' ? (
                            <>
                              <button
                                ...
                                className="bg-carehub-teal text-white px-4 py-2 rounded-lg hover:bg-carehub-teal-dark transition-all duration-300 flex items-center space-x-2 text-sm font-medium hover:scale-105"
                              >
                              ...
                              <Link
                                to={result.url}
                                className="border border-carehub-teal text-carehub-teal px-4 py-2 rounded-lg hover:bg-green-50 transition-all duration-300 text-sm font-medium hover:scale-105"
                              >
                                Xem chi tiết
                              </Link>
                            </>
                            ...
                            <Link
                              to={result.url}
                              className="bg-carehub-teal text-white px-4 py-2 rounded-lg hover:bg-carehub-teal-dark transition-all duration-300 text-sm font-medium hover:scale-105"
                            >
                              Đọc thêm
                            </Link>
                          )}
