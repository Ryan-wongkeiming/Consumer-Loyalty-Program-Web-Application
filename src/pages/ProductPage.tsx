        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center space-x-2 text-sm">
            <button
              ...
              className="text-carehub-teal hover:text-carehub-teal-dark transition-colors"
            >
              Tất cả sản phẩm
            </button>
            <span className="text-gray-400">/</span>
            <span className="text-carehub-teal font-medium bg-green-50 px-2 py-1 rounded">
              {product.category}
            </span>
            <span className="text-gray-400">/</span>
                ...
                <div 
                  ...
                  className={`aspect-square bg-white rounded-md shadow-sm overflow-hidden border-2 cursor-pointer transition-all duration-200 min-h-[60px] sm:min-h-[80px] ${
                    selectedImageIndex === index 
                      ? 'border-carehub-teal ring-2 ring-carehub-teal ring-opacity-50' 
          ...
          <div className="space-y-4 lg:space-y-6">
            <div>
              <div className="mb-2 flex items-center gap-2 flex-wrap">
                <span className="text-sm sm:text-base text-carehub-teal font-medium bg-green-50 px-3 py-1.5 rounded-full">
                  {product.category}
                </span>
                {product.brand && product.brand !== 'CareHub' && (
                  <span className="text-sm sm:text-base text-gray-500 font-medium bg-gray-100 px-3 py-1.5 rounded-full">
                    {product.brand}
                  </span>
                )}
              </div>
              ...
              <div className="bg-green-50 p-4 lg:p-5 rounded-lg border border-green-200">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    ...
                    />
                    <div className="w-12 h-7 sm:w-11 sm:h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-carehub-teal/30 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 sm:after:h-5 sm:after:w-5 after:transition-all peer-checked:bg-carehub-teal"></div>
                  </label>
                </div>
            ...
            <div className="space-y-3 lg:space-y-4">
              ...
              <button
                onClick={handleContinueShopping}
                className="w-full mt-3 bg-white border-2 border-carehub-teal text-carehub-teal px-4 lg:px-6 py-3.5 rounded-lg hover:bg-green-50 transition-all duration-300 font-medium text-sm sm:text-base hover:scale-[1.02] min-h-[48px]"
              >
                Tiếp tục mua sắm
              </button>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                  {product.benefits.map((benefit, index) => (
                    <div key={index} className="flex items-start space-x-3">
                      <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-carehub-teal mt-0.5 flex-shrink-0" />
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border-b border-gray-200 pb-6">
                      ...
                      <p className="text-gray-700">
                        CareHub has always been my go-to brand for supplements. This product is no exception - 
