      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <Link to="/womens-health" className="text-carehub-teal hover:text-carehub-teal-dark">
             Sức khỏe phụ nữ
            </Link>
            <span className="text-gray-400">/</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <Truck className="w-6 h-6 text-carehub-teal mx-auto mb-2" />
                <p className="text-xs text-gray-600">Free Shipping</p>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <Shield className="w-6 h-6 text-carehub-teal mx-auto mb-2" />
                <p className="text-xs text-gray-600">Quality Assured</p>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <RefreshCw className="w-6 h-6 text-carehub-teal mx-auto mb-2" />
          ...
          <div className="space-y-6">
            <div>
              <div className="mb-2">
                <span className="text-sm text-carehub-teal font-medium bg-green-50 px-3 py-1 rounded-full">
                  {product.category}
                </span>
              </div>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="font-bold text-carehub-teal">
              ...
              <div className="flex space-x-4">
                <button 
                  ...
                  className={`flex-1 px-6 py-3 rounded-lg transition-colors flex items-center justify-center space-x-2 font-medium ${
                    product.inStock
                      ? 'bg-carehub-teal text-white hover:bg-carehub-teal-dark'
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {product.benefits.map((benefit, index) => (
                    <div key={index} className="flex items-start space-x-3">
                      <CheckCircle className="w-5 h-5 text-carehub-teal mt-0.5 flex-shrink-0" />
