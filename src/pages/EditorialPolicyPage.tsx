...
import { ArrowLeft, MessageSquare, CheckCircle, XCircle, AlertTriangle, Shield } from 'lucide-react';
            ...
            <div className="space-y-8">
              <section>
                <div className="flex items-center space-x-3 mb-4">
                  <MessageSquare className="w-6 h-6 text-carehub-teal" />
                  <h2 className="text-2xl font-bold text-gray-900">Hướng Dẫn Chia Sẻ Nội Dung Trên Nền Tảng Của CareHub</h2>
                </div>
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>Lifeline: <a href="http://www.lifeline.org.au" className="text-carehub-teal hover:underline">http://www.lifeline.org.au</a></li>
                    <li>Kids Helpline: <a href="http://www.kidshelp.com.au" className="text-carehub-teal hover:underline">http://www.kidshelp.com.au</a></li>
                    <li>Australian Government Crisis Support: <a href="http://www.aifs.gov.au/acssa/crisis.html" className="text-carehub-teal hover:underline">http://www.aifs.gov.au/acssa/crisis.html</a></li>
                    <li>Samaritans Crisis Line: <a href="http://www.thesamaritans.org.au" className="text-carehub-teal hover:underline">http://www.thesamaritans.org.au</a></li>
                    <li>Relationships Australia: <a href="http://www.relationships.com.au/resources/crisis-telephone-numbers" className="text-carehub-teal hover:underline">http://www.relationships.com.au/resources/crisis-telephone-numbers</a></li>
                  </ul>
                  <p>
              ...
              <section>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                    ...
                    <li>Email: support@carehub.com</li>
