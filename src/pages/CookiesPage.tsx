            ...
            <div className="space-y-8">
              ...
              <section>
                <div className="flex items-center space-x-3 mb-4">
                  <Cookie className="w-6 h-6 text-carehub-teal" />
              ...
              <section>
                <div className="flex items-center space-x-3 mb-6">
                  <Settings className="w-6 h-6 text-carehub-teal" />
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-gray-300 rounded-lg overflow-hidden">
                    <thead>
                      <tr className="bg-carehub-teal text-white">
              ...
              <section>
                <div className="flex items-center space-x-3 mb-4">
                  <Globe className="w-6 h-6 text-carehub-teal" />
              ...
              <section>
                <div className="bg-gradient-to-r from-carehub-teal to-carehub-teal-dark text-white rounded-lg p-6">
                  <p className="text-lg leading-relaxed">
                    Bằng việc duy trì kết nối với CareHub, bạn giúp chúng tôi phục vụ tốt hơn và an tâm về cách dữ liệu của mình được bảo vệ. Nếu còn câu hỏi, đừng ngần ngại liên hệ chúng tôi qua mục "Liên Hệ" để được hỗ trợ.
                  </p>
                </div>
              </section>
