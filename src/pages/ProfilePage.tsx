...
const ProfilePage: React.FC = () => {
  ...
  const handleInputChange = (e: { target: { name: string; value: string; type?: string } }) => {
  ...
  const handleAddressInputChange = (e: { target: { name: string; value: string; type?: string } }) => {
    const { name, value, type } = e.target;
    if (type === 'checkbox') {
      setAddressFormData(prev => ({ ...prev, [name]: type === 'checkbox' }));
    } else {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Profile Header */}
      <div className="bg-gradient-to-r from-carehub-teal to-carehub-teal-dark text-white py-12">
                ...
                return (
                  <button
                    ...
                    className={`py-4 px-1 border-b-2 font-medium text-sm flex items-center space-x-2 transition-colors ${
                      activeTab === tab.id
                        ? 'border-carehub-teal text-carehub-teal'
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 text-carehub-teal hover:text-carehub-teal-dark transition-all duration-300 hover:scale-105 px-3 py-1 rounded-lg hover:bg-green-50"
                  >
                ...
                <div className="border-t pt-6">
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      onChange={handleInputChange}
                      disabled={!isEditing}
                      className="w-4 h-4 text-carehub-teal border-gray-300 rounded focus:ring-carehub-teal"
                    />
                    <label className="text-sm text-gray-700">
                      Tôi đồng ý nhận thông tin khuyến mãi và tin tức từ CareHub qua email
                    </label>
                  </div>
                </div>
                ...
                {isEditing && (
                  <div className="flex justify-end space-x-4 pt-6 border-t">
                    ...
                    <button
                      ...
                      disabled={isSaving}
                      className="flex items-center space-x-2 bg-carehub-teal text-white px-6 py-2 rounded-lg hover:bg-carehub-teal-dark transition-colors disabled:opacity-50"
                    >
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 bg-carehub-teal text-white px-4 py-2 rounded-lg hover:bg-carehub-teal-dark transition-colors"
                  >
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-2">
                            ...
                            {address.is_default && (
                              <span className="bg-carehub-teal text-white px-2 py-1 rounded text-xs font-medium">
                                Mặc định
                              </span>
                            )}
                          </div>
                        ...
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            className="text-carehub-teal hover:text-carehub-teal-dark transition-colors p-2"
                          >
                            <Edit className="w-4 h-4" />
                          </button>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-carehub-teal"
                        >
                      ...
                      <div>
                        ...
                        <SearchableSelect
                          ...
                          onChange={(value) => handleAddressInputChange({ target: { name: 'city', value } })}
                      ...
                      <div>
                        ...
                        <SearchableSelect
                          ...
                          onChange={(value) => handleAddressInputChange({ target: { name: 'ward', value } })}
              ...
              <div className="space-y-6">
                ...
                {loadingLoyalty ? (
                  <div className="text-center py-8">
                    <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-carehub-teal mx-auto mb-4"></div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <label className="relative inline-flex items-center cursor-pointer">
                          ...
                          />
                          <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-carehub-teal/30 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-carehub-teal"></div>
                        </label>
                      </div>
                    </div>
                  </div>
