            ...
            <div className="space-y-8">
              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Chúng Tôi Cam Kết Bảo Vệ Thông Tin Của Bạn Tại CareHub
                </h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Tại CareHub, chúng tôi luôn đặt sự riêng tư của bạn lên hàng đầu. Hệ thống bảo mật của chúng tôi được xây dựng vững chắc để đảm bảo mọi thứ đều tuân thủ nghiêm ngặt các quy định liên quan. Điều này bao gồm cam kết mạnh mẽ từ chúng tôi, cách tiếp cận rõ ràng về bảo mật mà bạn sẽ thấy trong tài liệu này, các tài nguyên công nghệ và dịch vụ chuyên dụng, cùng với đội ngũ nhân viên được đào tạo bài bản để xử lý mọi việc một cách chuyên nghiệp.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    Tùy vào cách bạn tương tác với CareHub, chúng tôi có thể cần thu thập một số thông tin cá nhân như tên, chi tiết liên lạc, hoặc thậm chí là tuổi tác và tình trạng sức khỏe của bạn. Chúng tôi chỉ làm điều này khi bạn liên hệ với chúng tôi, hoặc khi chúng tôi yêu cầu và bạn (hoặc ai đó được bạn ủy quyền) cung cấp.
                  </p>
                  <p>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                  ...
                  <li>Xem xét đơn xin việc nếu bạn ứng tuyển vào CareHub.</li>
              ...
              <section>
                <div className="flex items-center space-x-3 mb-4">
                  <Lock className="w-6 h-6 text-carehub-teal" />
              ...
              <section>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="mt-4 space-y-2 text-gray-700">
                    <p><strong>Email:</strong> privacy@carehub.com</p>
