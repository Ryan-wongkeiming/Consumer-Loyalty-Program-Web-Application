...
const WomensHealthPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center space-x-2 text-sm">
            <Link to="/" className="text-carehub-teal hover:text-carehub-teal-dark">
              Health hub
            </Link>
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-carehub-teal to-carehub-teal-dark text-white">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            ...
            <div className="relative flex-1 max-w-md">
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-carehub-teal focus:border-transparent"
              />
            ...
            {sortedPosts.map(post => (
              <div key={post.id} className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group flex flex-col h-full">
                ...
                <div className="p-6 flex flex-col flex-1">
                  <div className="mb-3">
                    <span className="text-xs text-carehub-teal font-medium bg-green-50 px-2 py-1 rounded">
                      {post.category}
                    </span>
                  </div>

                  <h3 className="font-bold text-gray-900 mb-3 line-clamp-2 hover:text-carehub-teal transition-colors cursor-pointer h-12 flex items-start">
                    <Link 
                      to={
                      ...
                      className="hover:text-carehub-teal transition-colors"
                    >
                      {post.title}
                    </Link>
                  </h3>
                    ...
                    {post.type === 'Product' ? (
                      <div className="flex space-x-2">
                        <Link
                          ...
                          className="flex-1 bg-carehub-teal text-white px-4 py-2 rounded-lg hover:bg-carehub-teal-dark transition-all duration-300 flex items-center justify-center space-x-2 text-sm font-medium hover:scale-105"
                        >
                        ...
                        <Link
                          to={`/womens-health/product/${post.id}`}
                          className="px-3 py-2 border border-carehub-teal text-carehub-teal rounded-lg hover:bg-green-50 transition-all duration-300 text-sm font-medium flex-shrink-0 hover:scale-105"
                        >
                          Chi tiết
                        </Link>
                      </div>
                      ...
                      <div>
                        <Link
                          ...
                          className="text-carehub-teal hover:text-carehub-teal-dark font-medium text-sm flex items-center space-x-1 group"
                        >
                          <span>Đọc thêm</span>
        ...
        {sortedPosts.length > 0 && (
          <div className="text-center mt-12">
            <Link
              ...
              className="bg-carehub-teal text-white px-8 py-3 rounded-lg hover:bg-carehub-teal-dark transition-colors font-medium inline-block"
            >
              Tải thêm kết quả
            </Link>
          </div>
      ...
      {/* Why Choose CareHub Section */}
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Tại sao chọn CareHub cho sức khỏe phụ nữ?
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-pink-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <div className="w-8 h-8 bg-carehub-teal rounded-full"></div>
              </div>
