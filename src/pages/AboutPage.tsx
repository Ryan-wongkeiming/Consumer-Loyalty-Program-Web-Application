...
const AboutPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-carehub-teal to-carehub-teal-dark text-white py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-green-100 max-w-3xl mx-auto">
            Sức khỏe tự nhiên và chăm só gia đình trong một nền tảng
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
              Nền tảng sức khỏe tự nhiên và chăm só gia đình hiện đại
            </h2>
            <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
              <p className="text-lg mb-6">
                CareHub được thành lập bởi một đội ngũ chuyên gia sức khỏe tự nhiên. 
                Với niềm tin mạnh mẽ rằng cơ thể con người có khả năng tự chữa lành khi được cung cấp đầy đủ dinh dưỡng, 
                chúng tôi tuyển chọn những sản phẩm sức khỏe tự nhiên chất lượng cao.
              </p>
              <p className="text-lg mb-6">
                Ngày nay, CareHub đã trở thành nền tảng mua sắm sức khỏe tự nhiên được nhiều gia đình tin tưởng 
                 Chúng tôi cam kết cải thiện sức khỏe và hạnh phúc của mọi người 
                thông qua các sản phẩm sức khỏe tự nhiên chất lượng cao, tuyển chọn kỹ lưỡng.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
                <Shield className="w-8 h-8 text-carehub-teal" />
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
                <Leaf className="w-8 h-8 text-carehub-teal" />
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
                <Heart className="w-8 h-8 text-carehub-teal" />
              </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-2xl p-8 mb-16">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-4">CareHub - Đồng hành cùng sức khỏe của bạn</h3>
                ...
                <p className="text-gray-700">
                  Triết lý này đã trở thành nền tảng cho tất cả các sản phẩm CareHub và tiếp tục 
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-carehub-teal rounded-full mr-3"></div>
                    Hôm nay: Đồng hành cùng hàng ngàn gia đình
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-carehub-teal rounded-full mr-3"></div>
                    Không ngừng mở rộng danh mục sản phẩm chất lượng
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-carehub-teal rounded-full mr-3"></div>
                    Hợp tác với các thương hiệu uy tín toàn cầu
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-carehub-teal rounded-full mr-3"></div>
                    Cam kết mang đến sản phẩm an toàn, chất lượng
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="text-left">
                <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                  <Award className="w-6 h-6 text-carehub-teal mr-2" />
              ...
              <div className="text-left">
                <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                  <Users className="w-6 h-6 text-carehub-teal mr-2" />
              ...
              <div className="text-left">
                <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                  <Globe className="w-6 h-6 text-carehub-teal mr-2" />
              ...
              <div className="text-left">
                <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                  <Shield className="w-6 h-6 text-carehub-teal mr-2" />
                  An toàn và Chất lượng
                </h3>
                <p className="text-gray-700 mb-4">
                  Mọi sản phẩm trên CareHub đều trải qua quá trình kiểm tra chất lượng nghiêm ngặt 
        ...
        {/* Global Presence */}
        <div className="bg-gradient-to-r from-carehub-teal to-carehub-teal-dark text-white rounded-2xl p-8 mb-16">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-8">
              Sự hiện diện toàn cầu
            </h2>
            <p className="text-xl text-green-100 mb-8">
              CareHub hiện mang đến các sản phẩm 
              sức khỏe tự nhiên chất lượng cao cho hàng triệu khách hàng.
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                <div className="text-3xl font-bold mb-2">100%</div>
                <div className="text-green-100">Cam kết chất lượng</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="text-green-100">Nền tảng đáng tin cậy</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              Tại CareHub, chúng tôi cam kết bằng cách 
            ...
            <div className="bg-green-50 rounded-lg p-6 border-l-4 border-carehub-teal">
              <p className="text-carehub-teal font-semibold text-lg">
                "Sức khỏe tự nhiên cho cuộc sống tự nhiên"
              </p>
              <p className="text-gray-600 mt-2">- Triết lý của CareHub</p>
            </div>
          </div>
        </div>
      </div>
