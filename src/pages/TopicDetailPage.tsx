          ...
          <div className="p-8">
            ...
            <div className="flex items-center justify-between border-b border-gray-200 pb-6 mb-8">
              <div className="flex items-center space-x-4">
                <button className="flex items-center space-x-2 text-gray-600 hover:text-carehub-teal transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {relatedTopics.map(relatedTopic => (
                ...
                >
                  ...
                  <div className="p-4">
                    <h3 className="font-semibold text-gray-900 mb-2 line-clamp-2 group-hover:text-carehub-teal transition-colors">
                      {relatedTopic.title}
                    </h3>
